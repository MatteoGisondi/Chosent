...
class AStar
{
    ...
    private int[,] _heuristicCost = null!;

    private int[,] _movementCost = null!;
    ...
    private void PrecomputeCost((int X, int Y) end)
    {
        ...
        _heuristicCost = new int[_map.GetLength(0), _map.GetLength(1)];
        _movementCost = new int[_map.GetLength(0), _map.GetLength(1)];
